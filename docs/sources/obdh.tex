...
\item The {\tt Coverage\_Timer} task is sporadic with a minimum separation of 60 s and a deadline of 0.2 s.
\end{itemize}
...
Coverage\_Timer & 60.0 & 0.2 & 15 \\
Basic\_TM & 10.0 & 0.5 & 12 \\
TC & 2.0 & 1.0 & 10 \\
Storage buffer & - & - & 20 \\ \hline
\end{tabular}
\caption{OBDH real-time requirements. Time values in seconds.}
